...
class hjStreamServer {
	...
	private static InputStream SRTSPDConf;
	...
	static {
		try {
			SRTSPDConf = new FileInputStream("config.crypto");
	...
	hjStreamServer() throws FileNotFoundException {
	}
	...
	static public void main(String []args ) throws Exception {
		...
		Properties SSPProperties = new Properties();
		SSPProperties.load(SRTSPDConf);
		getConfigs configs = new getConfigs(SSPProperties);
		...
		mySimplifiedSRTSPDatagramSockets s = new mySimplifiedSRTSPDatagramSockets(configs);
